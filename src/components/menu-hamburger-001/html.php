            ...
            <div class="menu-hamburger-001--box-contents">
                ...
                <ul class="menu-hamburger-001--box-items">
                    <li class="menu-hamburger-001--box-items-item menu-hamburger-001--has-submenu">
                        ...
                        <a class="menu-hamburger-001--box-items-item-link" href="https://google.com">
                        ...
                        <ul class="menu-hamburger-001--box-subitems menu-hamburger-001--box-subitems-none">
                            <li class="menu-hamburger-001--box-subitems-item"><a class="menu-hamburger-001--box-subitems-item-link" href="#">Subitem 01</a></li>
                            <li class="menu-hamburger-001--box-subitems-item"><a class="menu-hamburger-001--box-subitems-item-link" href="#">Subitem 02</a></li>
                            <li class="menu-hamburger-001--box-subitems-item"><a class="menu-hamburger-001--box-subitems-item-link" href="#">Subitem 03</a></li>
                            <li class="menu-hamburger-001--box-subitems-item"><a class="menu-hamburger-001--box-subitems-item-link" href="#">Subitem 04</a></li>
                        </ul>

                    </li>

                    <li class="menu-hamburger-001--box-items-item"><a class="menu-hamburger-001--box-items-item-link" href="https://google.com">Item 02</a></li>
                    <li class="menu-hamburger-001--box-items-item"><a class="menu-hamburger-001--box-items-item-link" href="#">Item 03</a></li>

                    <li class="menu-hamburger-001--box-items-item menu-hamburger-001--has-submenu">
                        <a class="menu-hamburger-001--box-items-item-link" href="#">
                            <span class="menu-hamburger-001--box-items-item-link-text">Item 04</span>
                            <svg class="menu-hamburger-001--box-items-item-link-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                <path class="menu-hamburger-001--box-items-item-link-svg-path" d="M233.4 406.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 338.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z"/>
                            </svg>
                        </a>
                    ...
                    <li class="menu-hamburger-001--box-items-item"><a class="menu-hamburger-001--box-items-item-link" href="#">Item 05</a></li>
                    <li class="menu-hamburger-001--box-items-item"><a class="menu-hamburger-001--box-items-item-link" href="#">Item 06</a></li>
                </ul>
                ...
                <div class="menu-hamburger-001--box-contacts">
                    ...
                    <ul class="menu-hamburger-001--box-contacts-items">
                        <li class="menu-hamburger-001--box-contacts-items-item">
                            <a class="menu-hamburger-001--box-contacts-items-item-link" href="#">
                                ...
                                <span class="menu-hamburger-001--box-contacts-items-item-link-text">suporte@imovago.com.br</span>
                            </a>
                        </li>
                        ...
                        <li class="menu-hamburger-001--box-contacts-items-item">
                            <a class="menu-hamburger-001--box-contacts-items-item-link" href="#">
                                ...
                                <span class="menu-hamburger-001--box-contacts-items-item-link-text">(49) 1234-5678</span>
                            </a>
                        </li>
                    ...
                    <div class="menu-hamburger-001--box-contacts-btn-call">
                        <a class="button-001" href="#">Ligamos para você!</a>
                    </div>
